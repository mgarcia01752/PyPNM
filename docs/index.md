...
- [Project overview](../README.md) - why PyPNM exists plus installer basics.
- [Install flow](../README.md#getting-started) - clone, run `./install.sh`, and bring up the FastAPI stack.
...
- [Security](../SECURITY.md) - responsible disclosure guidelines.

## Need more context?

- [Style guide](style-guide.md) - guidelines for writing or updating documentation.
- [Project roadmap / README next steps](../README.md#next-steps) - suggestions on what to explore after installation.
