...
## [SCP/SFTP File Retrieval](../system/pnm-file-retrieval/scp-sftp.md) with Remote TFTP Server
...
Script location on [GitHub](https://github.com/mgarcia01752/pypnm/blob/main/tools/pnm_file_retrieval_setup.py):
