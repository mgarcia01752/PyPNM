...
class Shannon:
    QAM_MODULATIONS: ClassVar[Dict[int, str]] = {
        1: "qam_2",
        2: "qam_4",
        3: "qam_8",
        4: "qam_16",
    ...
    @staticmethod
    def _snr_to_bits(snr_db: float) -> int:
    ...
    @staticmethod
    def bits_to_snr(bits: int) -> float:
        """
    ...
    @staticmethod
    def snr_to_limit(snr: Union[float, List[float], np.ndarray]) -> List[int]:
        """
