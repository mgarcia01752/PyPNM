...
def test_sysdescr_endpoint(mac: str, ip: str, url: str) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Target URL for the endpoint (default: http://localhost:8000/system/sysDescr)"
    )
    args = parser.parse_args()

    test_sysdescr_endpoint(args.mac, args.inet, args.url)
