...
class PnmResponse(CommonResponse):
    ...
    data: Optional[bytes | str | None] = Field(default=None, description="Raw or structured data resulting from the operation (e.g., text, JSON, or binary).")
...
class PnmFileResponse(CommonResponse):
    ...
    data: Optional[bytes | str | Any] = Field(default=None,description="Contents of the file or relevant metadata (could be binary or string).")
